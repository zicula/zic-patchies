 ...
 *
 * Contains schemas for 164 object types (audio + control).
 */
...
export const generatedObjectSchemas: ObjectSchemaRegistry = {
  ...
  'wam~': {
    type: 'wam~',
    category: 'audio',
    description: 'Web Audio Module instrument and effect host',
    inlets: [
      {
        id: 'in',
        type: 'signal',
        ...
        messages: [
          {
            schema: Type.Object({
              ...
              timeMode: Type.Optional(
                Type.Union([Type.Literal('absolute'), Type.Literal('relative')])
              )
            }),
            description: 'Set parameter by key'
          },
          {
            schema: Type.Object({
              type: Type.Literal('set'),
              params: Type.Any() /* unknown kind: Record */
            }),
            description: 'Set parameters by object'
          },
          {
            schema: Type.Object({ type: Type.Literal('save') }),
            description: 'Save the current state'
          },
          {
            schema: Type.Object({ type: Type.Literal('load'), url: Type.String() }),
            description: 'Load a module by URL'
          },
          {
            schema: Type.Object({ type: Type.Literal('load'), state: Type.Unknown() }),
            description: 'Load a module state'
          },
          {
            schema: Type.Object({
              type: Type.Literal('load'),
            ...
            description: 'Load a module by URL with state'
          },
          { schema: Type.Object({ type: Type.Literal('mute') }), description: 'Mute audio output' },
          {
            schema: Type.Object({ type: Type.Literal('unmute') }),
          ...
          },
          {
            ...
            description: 'Send MIDI note-off'
          },
          {
            schema: Type.Object({
            ...
            description: 'Send MIDI control change'
          },
          {
            schema: Type.Object({
          ...
          },
          {
            ...
            description: 'Send MIDI pitch bend'
          },
          {
            schema: Type.Object({
            ...
            description: 'Send MIDI channel pressure'
          },
          {
            schema: Type.Object({
            ...
            description: 'Send MIDI polyphonic pressure'
          },
          {
            schema: Type.Object({
    ...
    tags: ['audio', 'plugin', 'wam', 'midi', 'experimental']
  },
