...
- [CsoundObj](#CsoundObj) : <code>object</code>
  ...
  - _static_
    ...
    - [.getParams()](#CsoundObj.getParams) ⇒ [<code>Promise.&lt;CSOUND_PARAMS&gt;</code>](#CSOUND_PARAMS)
    ...
    - [.getMIDIDevList(isOutput)](#CsoundObj.getMIDIDevList) ⇒ [<code>Promise.&lt;CS_MIDIDEVICE&gt;</code>](#CS_MIDIDEVICE)
...
| ------------ | -------------------------------------------- | ------------------- |
| csoundParams | [<code>CSOUND_PARAMS</code>](#CSOUND_PARAMS) | csoundParams object |

<a name="CsoundObj.getParams"></a>

### CsoundObj.getParams() ⇒ [<code>Promise.&lt;CSOUND_PARAMS&gt;</code>](#CSOUND_PARAMS)
...
**Kind**: static method of [<code>CsoundObj</code>](#CsoundObj)
**Returns**: [<code>Promise.&lt;CSOUND_PARAMS&gt;</code>](#CSOUND_PARAMS) - - CSOUND_PARAMS object
...
### CsoundObj.getMIDIDevList(isOutput) ⇒ [<code>Promise.&lt;CS_MIDIDEVICE&gt;</code>](#CS_MIDIDEVICE)
